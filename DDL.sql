...
CREATE TABLE Concerts (
    ...
    numTicketsAvailable INT NOT NULL,
    numTicketsSold INT NOT NULL,
...
-- -----------------------------------------------------
-- Insert into Table Tours
-- -----------------------------------------------------

INSERT INTO Tours (tourID, tourName, tourStartDate, tourEndDate, concertTotal, artistID)
    VALUES
    (1, 'Swift As A Coursing River', '2024-03-04', '2024-10-23', 1, (SELECT artistID FROM Artists WHERE artistName = 'Taylor Swift')),
...
INSERT INTO Concerts (concertID, numTicketsAvailable, numTicketsSold, startDate, location, tourID)
    VALUES 
    (1, 10000, 4000, '2025-12-25 09:00:00', '97068', (SELECT tourID FROM Tours WHERE tourName = 'Creation')),
    (2, 30000, 29000, '2025-03-04 12:00:00', '97331', (SELECT tourID FROM Tours WHERE tourName = 'Swift As A Coursing River')),
    (3, 20000, 7000, '2025-01-19 05:00:00', '76043', (SELECT tourID FROM Tours WHERE tourName = 'Creation')),
    (4, 10000, 6000, '2025-04-08 06:00:00', '97303', (SELECT tourID FROM Tours WHERE tourName = 'Wow a Lizard')),
    (5, 25000, 23000, '2025-02-10 09:00:00', '10001', (SELECT tourID FROM Tours WHERE tourName = 'The Moonshine Jungle Tour'));
...
INSERT INTO Vendors (vendorID, vendorName, vendorProduct)
    ...
    (3, 'Concert Bartenders', 'Alcoholic and Non-Alcoholic Drinks');
